...
[Run the 74HC595 Datasheet Pinout Diagram Reader MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/beginning-electronics/sims/74hc595-datasheet-pinout-reader/main.html"
        height="722px"
        width="100%"
        scrolling="no"></iframe>
```

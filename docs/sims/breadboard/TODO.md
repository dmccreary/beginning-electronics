...
**MicroSim:** breadboard
**Repository:** beginning-electronics
...
- **Detected subjects:** Mathematics, Computer Science, Statistics, Engineering
- **Visualization types:** simulation, graph, interactive-demo, network
- **Has main.html:** No
- **Has index.md:** Yes

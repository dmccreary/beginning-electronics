...
[Run the Circuit Safety Hazard Explorer MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/beginning-electronics/sims/circuit-safety-hazard-explorer/main.html"
        height="482px"
        width="100%"
        scrolling="no"></iframe>
```

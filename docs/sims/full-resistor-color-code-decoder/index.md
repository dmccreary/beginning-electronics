...
[Run the Full Resistor Color Code Decoder MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/beginning-electronics/sims/full-resistor-color-code-decoder/main.html"
        height="502px"
        width="100%"
        scrolling="no"></iframe>
```

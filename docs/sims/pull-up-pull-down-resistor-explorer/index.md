...
[Run the Pull-Up and Pull-Down Resistor Explorer MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/beginning-electronics/sims/pull-up-pull-down-resistor-explorer/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```

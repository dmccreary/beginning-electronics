...
[Run the Circuit Diagram and Schematic Symbol Explorer MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/beginning-electronics/sims/schematic-symbol-explorer/main.html"
        height="472px"
        width="100%"
        scrolling="no"></iframe>
```

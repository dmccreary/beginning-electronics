...
[Run the Solar Panel Charging Circuit Explorer MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/beginning-electronics/sims/solar-charging-circuit-explorer/main.html"
        height="542px"
        width="100%"
        scrolling="no"></iframe>
```

...
[Run the Transistor AND and OR Logic Gates with Live Truth Table MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/beginning-electronics/sims/transistor-and-or-logic-gates/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```

...
[Run the Transistor Gate Explorer with LED Output MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/beginning-electronics/sims/transistor-gate-explorer/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```

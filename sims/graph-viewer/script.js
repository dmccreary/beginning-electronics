...
function initializeNetwork() {
    ...
    const options = {
        ...
        layout: {
            randomSeed: 42,
            // vis-network's improved layout algorithm only supports graphs
            // up to ~150 nodes; this graph has 500, so it must stay off or
            // vis-network logs a warning and silently falls back anyway.
